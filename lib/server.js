...
function requestHandler(req, res) {
  ...
  // Normalize the pathname using POSIX path normalization for cross-platform compatibility
  // This handles ".." and ensures paths don't escape the root, while avoiding Windows-specific behavior
